...
public class TasksController extends BaseController {    
     ...
     * @return The singleton instance of the TasksController class 
     */
     ...
     */
    public void updateTasksValidateAsync(
                final TaskValidationWriterServiceModel task,
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5215059340283613553L;
            {
        ...
        final HttpRequest _request = getClientInstance().putBody(_queryUrl, _headers, APIHelper.serialize(task),
     ...
     * @return    Returns the void response from the API call 
     */
    public void getTasksGetAnswerChoicesAsync(
                final int id,
                final String acceptLanguage,
                final APICallBack<DynamicResponse> callBack
    ) {
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5716855265177453147L;
            {
                    put( "id", id );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5192796605488146094L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Accept-Language", (null != acceptLanguage) ? acceptLanguage : "fr" );
     ...
     * @return    Returns the void response from the API call 
     */
    public void getTasksGetAnswerTextsAsync(
                final int id,
                final String acceptLanguage,
                final APICallBack<DynamicResponse> callBack
    ) {
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4638172079220314026L;
            {
                    put( "id", id );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5245444380788497372L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Accept-Language", (null != acceptLanguage) ? acceptLanguage : "fr" );
    ...
    public void getTasksGetAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4790616705773396262L;
            {
                    put( "id", id );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4886700500023435742L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Accept-Language", (null != acceptLanguage) ? acceptLanguage : "fr" );
